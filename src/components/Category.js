    ...
    return (
        <main className="w-[260px] h-[800px] bg-[#ffffff] absolute top-0 left-0 z-20 border-solid border border-[#afafaf]">
            ...
            <ul className="w-[258px] absolute bottom-[0px] left-[0px]">
                ...
                <Link to="/calendar">
                    <li className="text-[20px] py-[15px] pl-[25px] border-solid border-t border-[#afafaf]"
                        onClick={hideCategory}>캘린더</li>
                </Link>
                {/* 타이머 */}
                <Link to="/timer">
                    <li className="text-[20px] py-[15px] pl-[25px] border-solid border-t border-[#afafaf]"
                        onClick={hideCategory}>타이머</li>
                </Link>
                {/* 주변 헬스장 찾기 */}
                <Link to="/mapSearch">
                    <li className="text-[20px] py-[15px] pl-[25px] border-solid border-t border-[#afafaf]"
                        onClick={hideCategory}>주변 헬스장 찾기</li>
                </Link>
                {/* 내 정보 보기 */}
                <Link to="/myInfo">
                    <li className="text-[20px] py-[15px] pl-[25px] border-solid border-t border-[#afafaf]"
                        onClick={hideCategory}>내 정보 보기</li>
                </Link>
                {/* 설정하기 */}
                <Link to="/settings">
                    <li className="text-[20px] py-[15px] pl-[25px] border-solid border-t border-[#afafaf]"
                        onClick={hideCategory}>설정하기</li>
                </Link>
            </ul>
        </main>
    )
